...
#    &{CorrectUserName_IncorrectPassword}
#    &{IncorrectUsername_CorrectPassword}
#    &{IncorrectPassword_IncorrectUsername}
...
#    AppiumLibrary.Close Application
User open the article and change languages and front size of the article
    Open And Load Application
    Skip Settings
    Search The Article
    Open The Article
